...
import com.project.lakesidehotels.repository.RoomRepository;
...
public class RoomServiceImpl implements IRoomService {
	...
	/*
	 * while adding new room before saving MultipartFile -> extracting bytes and
	 * converting to byte[] -> and byte[] converting to Blob
	 */
	@Override
